...
void flyInCircle(const float x, const float y, const float z, ros::Rate& rate) {
    ...
    for(int i = 1; i < 101; i++){  // Loop to create waypoints for a circular path
        ...
        des_z = z;  // Calculate desired Z position
...
int main(int argc, char **argv) {
    ...
    flyInCircle(curr_x, curr_y, curr_z, rate);  // Fly in a circular path
