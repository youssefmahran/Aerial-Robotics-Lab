...
class DroneController:  # Define the DroneController class
    ...
    def flyInHelix(self, x, y, z):  # Define the flyInHelix method
        ...
        for i in range(1, 101):  # Loop 100 times to create a circular path
            ...
            self.des_z = z + i * (1.8 / 360) # Calculate the desired z position
...
if __name__ == "__main__":  # Main script execution starts here
    ...
    controller.flyInHelix(controller.curr_x, controller.curr_y, controller.curr_z) # Fly in a helical path
