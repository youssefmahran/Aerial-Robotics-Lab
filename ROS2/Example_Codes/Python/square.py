...
class DroneController:  # Define the DroneController class
    ...
    def flyInSquare(self, x, y, z):  # Define the flyInSquare method
        ...
        for i in range(0, 4):  # Loop 4 times to create a square path
...
if __name__ == "__main__":  # Main script execution starts here
    ...
    controller.flyInSquare(controller.curr_x, controller.curr_y, controller.curr_z) # Fly in a square path
